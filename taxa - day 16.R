...
my_colors <- c(
  ...
  "#AD6F3B", "#673770","#D72858", "#652926", "#C84248", 
...
resd0 = results(diagdds, contrast = my_contrast, cooksCutoff = FALSE)

sigtabd0 = res[which(resd0$padj < alpha), ]
#sigtab_test <- as(sigtab, "data.frame")
sigtabd0 = cbind(as(sigtabd0, "data.frame"), as(tax_table(physeq_deseqd0)[rownames(sigtabd0), ], "matrix"))
#head(sigtab)
...
ggsave(paste0("output/DESeq2-16", my_contrast[2], "-", my_contrast[3], ".png"), DESeq_fig, height = 5, width = 10)
